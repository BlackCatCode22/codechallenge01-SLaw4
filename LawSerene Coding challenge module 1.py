...
#
print("\n\n\n\n")
print("Welcome to CIT-95 Spring 2023 Module 01 Code Challenge!")
...
print("   the $ in our figure is at index: ", str(
    find_number_hiding_in_str(pay_statement)))
...
index_of_space_after_money = pay_statement.find(
    " ", find_number_hiding_in_str(pay_statement))
...
some_number = float("852.10")
annual_salary = some_number * 52
print(annual_salary)

print(some_number)

my_new_num = some_number * 52
print("\n\n The annual salary is $" + str(my_new_num))
formatted_annual_salary = f'${my_new_num:,.2f}'
print(formatted_annual_salary)


def find_number_hiding_in_str(the_str_num):
    the_number_result = 0.0
    the_index = the_str_num("$")
    return the_index


pay_statement = "Katrina's annual salary working " + weeks + " at " + \
    weekly_pay + " per week is " + str(formatted_annual_salary) + " per year."
print(pay_statement)
